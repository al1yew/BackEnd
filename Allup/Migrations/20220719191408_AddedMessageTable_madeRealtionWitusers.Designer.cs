...
namespace Allup.Migrations
{
    ...
    [Migration("20220719191408_AddedMessageTable_madeRealtionWitusers")]
    partial class AddedMessageTable_madeRealtionWitusers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Allup.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Allup.Models.Message", b =>
                {
                    b.HasOne("Allup.Models.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("Allup.Models.AppUser", "Sender")
                        .WithMany()
